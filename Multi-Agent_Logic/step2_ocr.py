...
def screenshot_ocr(user_goal):
    ...
    print( screenshot_content)

screenshot_ocr("navigate to the github website and create a new repository. For every screenshot extract the key information and return it.")